...
export default function ReturnGuide() {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={{ paddingTop: insets.top, paddingBottom: insets.bottom + 20 }} bounces={false}>
            ...
            <View style={styles.content}>
                ...
                <TouchableOpacity style={styles.actionButton} activeOpacity={0.8} onPress={handleDownloadLabel}>
...
const styles = StyleSheet.create({
    ...
    mainTitle: { color: "#FFFFFF", fontSize: 32, fontWeight: "bold", marginBottom: 40, textAlign: "center" },
    stepsContainer: { width: "auto", minWidth: 260, marginBottom: 60, gap: 24, alignSelf: "center" },
    stepRow: { flexDirection: "row", alignItems: "center", width: "100%" },
    stepCircle: { width: 48, height: 48, borderRadius: 24, backgroundColor: "#CC9D36", justifyContent: "center", alignItems: "center", marginRight: 20 },
    stepNumber: { color: "#000000", fontSize: 18, fontWeight: "bold" },
    stepText: { color: "#FFFFFF", fontSize: 16, fontWeight: "400", flex: 1 },
    actionButton: { backgroundColor: "#CC9D36", borderRadius: 12, height: 50, alignItems: "center", justifyContent: "center", width: "100%", marginBottom: 20 },
    buttonText: { color: "#000000", fontSize: 16, fontWeight: "bold" },
    footerText: { color: "#8E8E93", fontSize: 14, fontWeight: "400", marginTop: 10 }
});